...
def test_SingletonDetectionSlower():
    runner = get_runner("verilator")
    runner.build(
        sources=["rtl/SingletonDetectionSlower.sv"],
        hdl_toplevel="SingletonDetectionSlower",
        parameters={"N": N},
        build_args=["--public-flat-rw"],
    )
    runner.test(
        hdl_toplevel="SingletonDetectionSlower",
        test_module="test_SingletonDetectionSlower",
    )