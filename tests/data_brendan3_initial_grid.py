...
data_brendan3_initial_grid = GridState(
    N = 3, # puzzle size
    V = 9, # number of variables in the grid
    CC = 5, ## colour count
    UNASSIGNED_VARIABLES = 0b111111111, # variables yet to be allocated a variable
    UNASSIGNED_TILES     = 0b111111111, # tiles yet to be forced into a single position
    R0 = [
        0b000000000, 0b000000000, 0b000000000, 
        0b000000000, 0b100000000, 0b000000000, 
        0b000001111, 0b011110000, 0b000000000],
    R1 = [
        0b000001111, 0b000000000, 0b000000000, 
        0b011110000, 0b100000000, 0b000000000, 
        0b000000000, 0b000000000, 0b000000000],
    R2 = [
        0b000000000, 0b011110000, 0b000001111, 
        0b000000000, 0b100000000, 0b000000000, 
        0b000000000, 0b000000000, 0b000000000],
    R3 = [
        0b000000000, 0b000000000, 0b000000000, 
