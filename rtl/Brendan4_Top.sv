...
// Brendan4_Top
//
//! Top-level module for the Brendan4 puzzle (4x4).
//!
//! Wires together Brendan4_Load and Brendan4_Solve.
...
module Brendan4_Top (
    ...
    // ── Wires from Brendan4_Load ──────────────────────────────
    logic [15:0][5:0]  w_elements_top;         //! top colour for each tile.
    logic [15:0][5:0]  w_elements_right;       //! right colour for each tile.
    logic [15:0][5:0]  w_elements_bottom;      //! bottom colour for each tile.
    logic [15:0][5:0]  w_elements_left;        //! left colour for each tile.

    logic [15:0][5:0]  w_colours_top;          //! initial top colour mask for each variable.
    logic [15:0][5:0]  w_colours_right;        //! initial right colour mask for each variable.
    logic [15:0][5:0]  w_colours_bottom;       //! initial bottom colour mask for each variable.
    logic [15:0][5:0]  w_colours_left;         //! initial left colour mask for each variable.
