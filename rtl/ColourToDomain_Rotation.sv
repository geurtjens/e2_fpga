...
module ColourToDomain_Rotation #(
    parameter int V = 16, //! n*n
    parameter int CC = 6
)(
    input  logic [V-1:0] in_domain,

    input  logic [CC-1:0] in_colour_top,
    input  logic [CC-1:0] in_colour_right,
    input  logic [CC-1:0] in_colour_bottom,
    input  logic [CC-1:0] in_colour_left,
