...
module Brendan8_Load (
    // ── Tile elements ─────────────────────────────────────────
    output logic [63:0][11:0]  out_elements_top,         //! top colour for each tile.
    output logic [63:0][11:0]  out_elements_right,       //! right colour for each tile.
    output logic [63:0][11:0]  out_elements_bottom,      //! bottom colour for each tile.
    output logic [63:0][11:0]  out_elements_left,        //! left colour for each tile.
    ...
    // ── Brendan8_Elements ─────────────────────────────────────────
    //! Provides the colour masks for all 64 tiles in their base
