...
module Assignment_Complex #(
    ...
    // ── Assignment inputs ──────────────────────────────────────
    input  logic [ID_BITS-1:0] variableId, //! position in the grid that we will store the value
    input  logic [ID_BITS-1:0] tileId,   //! value that we are assigning
    input  logic [1:0]         rotation, //! rotation of tile (0,1,2,3)
