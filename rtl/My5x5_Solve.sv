...
// My5x5_Solve
//
//! Solver for the My5x5 puzzle (5x5).
//!
//! Receives the initial game state from My5x5_Load and
//! runs the constraint propagation and search algorithm.
//!
//! N=5, V=25, CC=23, VAR_BIT_SIZE=5
// ─────────────────────────────────────────────────────────────
module My5x5_Solve (
    input  logic        clk,                            //! 50 MHz clock.

    // ── Tile elements ─────────────────────────────────────────
    input  logic [24:0][22:0]  in_elements_top,      //! top colour for each tile.
    input  logic [24:0][22:0]  in_elements_right,    //! right colour for each tile.
    input  logic [24:0][22:0]  in_elements_bottom,   //! bottom colour for each tile.
    input  logic [24:0][22:0]  in_elements_left,     //! left colour for each tile.

    // ── Initial colours ───────────────────────────────────────
    input  logic [24:0][22:0]  in_colours_top,       //! initial top colour mask for each variable.
    input  logic [24:0][22:0]  in_colours_right,     //! initial right colour mask for each variable.
    input  logic [24:0][22:0]  in_colours_bottom,    //! initial bottom colour mask for each variable.
    input  logic [24:0][22:0]  in_colours_left,      //! initial left colour mask for each variable.
