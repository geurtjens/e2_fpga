...
module ChooseNextVariable_ComputeDomainSizes #(
    ...
    input  logic [V-1:0][V-1:0] in_domain_r1, //! original domain rotation 1
    input  logic [V-1:0][V-1:0] in_domain_r2, //! original domain rotation 2
    input  logic [V-1:0][V-1:0] in_domain_r3, //! original domain rotation 3
