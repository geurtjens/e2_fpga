...
//!
//! Wires together Brendan3_Load and Brendan3_Solve.
...
module Brendan3_Top (
    ...
    logic [8:0][4:0]  w_elements_top;         //! top colour for each tile.
    logic [8:0][4:0]  w_elements_right;       //! right colour for each tile.
    logic [8:0][4:0]  w_elements_bottom;      //! bottom colour for each tile.
    logic [8:0][4:0]  w_elements_left;        //! left colour for each tile.

    logic [8:0][4:0]  w_colours_top;          //! initial top colour mask for each variable.
    logic [8:0][4:0]  w_colours_right;        //! initial right colour mask for each variable.
    logic [8:0][4:0]  w_colours_bottom;       //! initial bottom colour mask for each variable.
    logic [8:0][4:0]  w_colours_left;         //! initial left colour mask for each variable.
