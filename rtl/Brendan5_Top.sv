...
// Brendan5_Top
//
//! Top-level module for the Brendan5 puzzle (5x5).
//!
//! Wires together Brendan5_Load and Brendan5_Solve.
...
module Brendan5_Top (
    ...
    // ── Wires from Brendan5_Load ──────────────────────────────
    logic [24:0][7:0]  w_elements_top;         //! top colour for each tile.
    logic [24:0][7:0]  w_elements_right;       //! right colour for each tile.
    logic [24:0][7:0]  w_elements_bottom;      //! bottom colour for each tile.
    logic [24:0][7:0]  w_elements_left;        //! left colour for each tile.

    logic [24:0][7:0]  w_colours_top;          //! initial top colour mask for each variable.
    logic [24:0][7:0]  w_colours_right;        //! initial right colour mask for each variable.
    logic [24:0][7:0]  w_colours_bottom;       //! initial bottom colour mask for each variable.
    logic [24:0][7:0]  w_colours_left;         //! initial left colour mask for each variable.
